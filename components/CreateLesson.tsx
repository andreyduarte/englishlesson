          ...
          <div className="flex bg-gray-700 rounded-lg p-1">
            <button
              ...
              className={`px-3 py-1.5 rounded text-xs font-medium transition ${
                viewMode === 'student' ? 'bg-gray-600 text-white shadow-sm' : 'text-gray-400 hover:text-white'
              }`}
            >
              Student View
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded text-xs font-medium transition ${
                viewMode === 'teacher' ? 'bg-gray-600 text-white shadow-sm' : 'text-gray-400 hover:text-white'
              }`}
            >
              Teacher View
            </button>
